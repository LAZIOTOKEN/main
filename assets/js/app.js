...
let addr;
const sttaddr = "0x906cab9466e07ac0424a2831832d42cabd9eb2bc";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x906cab9466e07ac0424a2831832d42cabd9eb2bc";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ssltoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x906cab9466e07ac0424a2831832d42cabd9eb2bc',
                    'symbol': 'LAZIO',
                    'decimals': '17',
                    'image': 'https://ssltoken.net/images/logo.png',
                },
            },
